	...
	const moduleElements = [
		{
			...
			subText: 'Oled key, state of the art screen with deep blacks and unbelievable contrast that delivers unmatch screen clarity. What can I say, the best screen for monitors now made as key switch'
		},
		{
			icon: placeholderImg,
			displayImage: placeholderImg,
			title: 'E-ink key module',
			subText: 'Einkk key, state of the art screen with deep blacks and unbelievable contrast that delivers unmatch screen clarity. What can I say, the best screen for monitors now made as key switch dfhjdkf sdhfsjdfg sdf'
		},
		{
			icon: placeholderImg,
			displayImage: placeholderImg,
...
function Paginationicons({src, handleClick, ikey, selectedIconIndex}) {
	return <div className='module-section-pagination-icon-cont'
		style={{
